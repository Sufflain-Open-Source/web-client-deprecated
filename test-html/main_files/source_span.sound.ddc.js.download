define(['dart_sdk', 'packages/path/path', 'packages/collection/src/canonicalized_map', 'packages/term_glyph/src/generated/ascii_glyph_set'], (function load__packages__source_span__source_span(dart_sdk, packages__path__path, packages__collection__src__canonicalized_map, packages__term_glyph__src__generated__ascii_glyph_set) {
  ...
  span['SourceSpanExtension|messageMultiple'] = function SourceSpanExtension$124messageMultiple($this, message, label, secondarySpans, opts) {
    ...
    let buffer = (t1 = new core.StringBuffer.new(), (() => {
      t1.write("line " + dart.str($this.start.line + 1) + ", column " + dart.str($this.start.column + 1));
      return t1;
    })());
    if ($this.sourceUrl != null) buffer.write(" of " + path.prettyUri($this.sourceUrl));
    t1$ = buffer;
  ...
  span['SourceSpanExtension|subspan'] = function SourceSpanExtension$124subspan($this, start, end = null) {
    ...
    let newStartLocation = new location.SourceLocation.new(startLocation.offset + start, {sourceUrl: $this.sourceUrl, line: line, column: column});
    ...
    if (end == null || end === $this.length) {
      ...
      newEndLocation = new location.SourceLocation.new(startLocation.offset + dart.notNull(end), {sourceUrl: $this.sourceUrl, line: line, column: column});
    }
  ...
  location.SourceLocation = class SourceLocation extends core.Object {
    ...
    get hashCode() {
      let t6, t6$;
      return dart.notNull((t6$ = (t6 = this.sourceUrl, t6 == null ? null : dart.hashCode(t6)), t6$ == null ? 0 : t6$)) + this.offset;
    }
    toString() {
  ...
  highlighter.Highlighter = class Highlighter extends core.Object {
    ...
    static _collateLines(highlights) {
      let highlightsByUrl = functions.groupBy(highlighter._Highlight, T.UriN(), highlights, dart.fn(highlight => highlight.span.sourceUrl, T._HighlightToUriN()));
      ...
      return highlightsByUrl[$values][$expand](highlighter._Line, dart.fn(highlightsForFile => {
        ...
        for (let line of lines) {
          activeHighlights[$removeWhere](dart.fn(highlight => !dart.equals(highlight.span.sourceUrl, line.url) || highlight.span.end.line < line.number, T._HighlightTobool()));
    ...
    [_writeFileStart](url) {
      if (!this[_multipleFiles] || url == null) {
    ...
    [_writeMultilineHighlights](line, highlightsByColumn, opts) {
      ...
      for (let highlight of highlightsByColumn) {
        let startLine = (t7 = highlight, t7 == null ? null : t7.span.start.line);
        let endLine = (t7$ = highlight, t7$ == null ? null : t7$.span.end.line);
        if (current != null && dart.equals(highlight, current)) {
          foundCurrent = true;
          if (!(startLine === line.number || endLine === line.number)) dart.assertFailed(null, I[4], 299, 16, "startLine == line.number || endLine == line.number");
          ...
          }, T.VoidTovoid()), {color: highlight.isPrimary ? this[_primaryColor$] : this[_secondaryColor$]});
        }
      }
    }
    ...
    [_writeUnderline](line, span, character) {
      let t7;
      if (!!utils.isMultiline(span)) dart.assertFailed(null, I[4], 411, 12, "!isMultiline(span)");
      if (!line.text[$contains](span.text)) dart.assertFailed(null, I[4], 412, 12, "line.text.contains(span.text)");
      ...
      (() => {
        ...
        t7.write(character[$times](math.max(core.int, endColumn - startColumn, 1)));
        return t7;
      })();
    }
    [_writeArrow](line, column, opts) {
      ...
      t7 = this[_buffer];
      (() => {
        t7.write(top_level.horizontalLine[$times](1 + column + tabs * (4 - 1)));
        t7.write("^");
        return t7;
      })();
    }
    ...
    [_writeSidebar](opts) {
      ...
      if (!(line == null || text == null)) dart.assertFailed(null, I[4], 464, 12, "line == null || text == null");
  ...
  (highlighter.Highlighter.multiple = function(primarySpan, primaryLabel, secondarySpans, opts) {
    ...
    highlighter.Highlighter.__.call(this, highlighter.Highlighter._collateLines((() => {
      let t6 = T.JSArrayOf_Highlight().of([new highlighter._Highlight.new(primarySpan, {label: primaryLabel, primary: true})]);
      for (let entry of secondarySpans[$entries])
        t6[$add](new highlighter._Highlight.new(entry.key, {label: entry.value}));
      return t6;
    })()), color ? (t7 = primaryColor, t7 == null ? "[31m" : t7) : null, color ? (t7$ = secondaryColor, t7$ == null ? "[34m" : t7$) : null);
  }).prototype = highlighter.Highlighter.prototype;
  (highlighter.Highlighter.__ = function(_lines, _primaryColor, _secondaryColor) {
    ...
    this[_maxMultilineSpans] = _lines[$map](core.int, dart.fn(line => line.highlights[$where](dart.fn(highlight => utils.isMultiline(highlight.span), T._HighlightTobool()))[$length], T._LineToint()))[$reduce](dart.gbind(C[0] || CT.C0, core.int));
    this[_multipleFiles] = !utils.isAllTheSame(_lines[$map](T.ObjectN(), dart.fn(line => line.url, T._LineToUriN())));
    ;
  }).prototype = highlighter.Highlighter.prototype;
  ...
  location_mixin.SourceLocationMixin = class SourceLocationMixin extends core.Object {
    ...
    get hashCode() {
      let t7, t7$;
      return dart.notNull((t7$ = (t7 = this.sourceUrl, t7 == null ? null : dart.hashCode(t7)), t7$ == null ? 0 : t7$)) + this.offset;
    }
    toString() {
      return "<" + dart.str(this[$runtimeType]) + ": " + dart.str(this.offset) + " " + this.toolString + ">";
    }
  ...
  span_exception.SourceSpanFormatException = class SourceSpanFormatException extends span_exception.SourceSpanException {
    ...
    get offset() {
      let t9;
      t9 = this.span;
      return t9 == null ? null : t9.start.offset;
    }
  };
